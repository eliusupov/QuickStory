/*
 * Evan job advancement 4th - "Dragon Master 4th Job Advancement", quest 22103.
 * Mir (npc 1013000): 2211 -> 2212 at level 40, after quest 22102.
 *
 * v84 Check.img/22103 = npc 1013000, lvmin 40, job 2211, quest 22102 state 2,
 * startscript q22103s, normalAutoStart 1, and NO endscript; Act.img/22103 and Say.img/22103
...
function start(mode, type, selection) {
    ...
    if (qm.getJob().getId() != 2211) {
        qm.dispose();   // wrong job, or already advanced - nothing to do
        return;
    }
    if (qm.getLevel() < 40) {
        qm.sendOk("Not yet, master. Come back when you have reached #blevel 40#k.");
        qm.dispose();
        return;
    }
    status++;
