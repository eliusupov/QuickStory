/*
 * Evan job advancement 5th - "Dragon Master 5th Job Advancement", quest 22104.
 * Mir (npc 1013000): 2212 -> 2213 at level 50, after quest 22103.
 *
 * v84 Check.img/22104 = npc 1013000, lvmin 50, job 2212, quest 22103 state 2,
 * startscript q22104s, normalAutoStart 1, and NO endscript; Act.img/22104 and Say.img/22104
...
function start(mode, type, selection) {
    ...
    if (qm.getJob().getId() != 2212) {
        qm.dispose();   // wrong job, or already advanced - nothing to do
        return;
    }
    if (qm.getLevel() < 50) {
        qm.sendOk("Not yet, master. Come back when you have reached #blevel 50#k.");
        qm.dispose();
        return;
    }
    status++;
    ...
    if (status == 0) {
        ...
        qm.sendNext("Mir has grown again. He is getting bigger and bigger... He's getting kind of scary?!\r\n\r\nYou have received #bSP#k and #bAP#k. Open the Skill window to see what I can do now, master!");
    } else {
        qm.dispose();
    }
}