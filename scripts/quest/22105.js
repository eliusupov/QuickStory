/*
 * Evan job advancement 6th - "Dragon Master 6th Job Advancement", quest 22105.
 * Mir (npc 1013000): 2213 -> 2214 at level 60, after quest 22104.
 *
 * v84 Check.img/22105 = npc 1013000, lvmin 60, job 2213, quest 22104 state 2,
 * startscript q22105s, normalAutoStart 1, and NO endscript; Act.img/22105 and Say.img/22105
...
function start(mode, type, selection) {
    ...
    if (qm.getJob().getId() != 2213) {
        qm.dispose();   // wrong job, or already advanced - nothing to do
        return;
    }
    if (qm.getLevel() < 60) {
        qm.sendOk("Not yet, master. Come back when you have reached #blevel 60#k.");
        qm.dispose();
        return;
    }
    status++;
    ...
    if (status == 0) {
        ...
        qm.sendNext("Mir has grown again and learned a new skill. Just how much bigger is he going to get?\r\n\r\nYou have received #bSP#k and #bAP#k. Open the Skill window to see what I can do now, master!");
    } else {
        qm.dispose();
    }
}