/*
 * Evan story quest 22593. v84 Check.img/22593: npc 2012012, lvmin 70, startscript q22593s
 * and no endscript - so only the accept side is server scripted. Completion runs Cosmic's
 * normal quest path and Act.img/22593 pays the rewards; nothing is owed here.
 *
 * ponytail: one screen, not an invented conversation. Say.img/22593/0 is empty in v84 - GMS
...
function start(mode, type, selection) {
    qm.forceStartQuest();
    qm.sendOk("Talk to #p2012012# to continue.");
    qm.dispose();
}