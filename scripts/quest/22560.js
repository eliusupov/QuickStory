/*
 * Evan story quest 22560. v84 Check.img/22560: npc 1063018, lvmin 36, startscript q22560s
 * and no endscript - so only the accept side is server scripted. Completion runs Cosmic's
 * normal quest path and Act.img/22560 pays the rewards; nothing is owed here.
 *
 * ponytail: one screen, not an invented conversation. Say.img/22560/0 is empty in v84 - GMS
...
function start(mode, type, selection) {
    qm.forceStartQuest();
    qm.sendOk("Defeat #r150#k #o3230100#, then talk to #p1063018#.");
    qm.dispose();
}