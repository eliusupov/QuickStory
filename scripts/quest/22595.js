/*
 * Evan story quest 22595. v84 Check.img/22595: npc 2041004, lvmin 70, startscript q22595s
 * and no endscript - so only the accept side is server scripted. Completion runs Cosmic's
 * normal quest path and Act.img/22595 pays the rewards; nothing is owed here.
 *
 * ponytail: one screen, not an invented conversation. Say.img/22595/0 is empty in v84 - GMS
...
function start(mode, type, selection) {
    qm.forceStartQuest();
    qm.sendOk("Talk to #p2041004# to continue.");
    qm.dispose();
}