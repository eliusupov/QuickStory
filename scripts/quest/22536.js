/*
 * Evan story quest 22536. v84 Check.img/22536: npc 1052103, lvmin 28, startscript q22536s
 * and no endscript - so only the accept side is server scripted. Completion runs Cosmic's
 * normal quest path and Act.img/22536 pays the rewards; nothing is owed here.
 *
 * ponytail: one screen, not an invented conversation. Say.img/22536/0 is empty in v84 - GMS
...
function start(mode, type, selection) {
    qm.forceStartQuest();
    qm.sendOk("Talk to #p1052103# to continue.");
    qm.dispose();
}