/*
 * Evan story quest 22581. v84 Check.img/22581: npc 1013202, lvmin 67, startscript q22581s
 * and no endscript - so only the accept side is server scripted. Completion runs Cosmic's
 * normal quest path and Act.img/22581 pays the rewards; nothing is owed here.
 *
 * ponytail: one screen, not an invented conversation. Say.img/22581/0 is empty in v84 - GMS
...
function start(mode, type, selection) {
    qm.forceStartQuest();
    qm.sendOk("Talk to #p1013203# to continue.");
    qm.dispose();
}