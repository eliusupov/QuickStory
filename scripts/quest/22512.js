/*
 * Evan story quest 22512. v84 Check.img/22512: npc 1013000, lvmin 14, startscript q22512s
 * and no endscript - so only the accept side is server scripted. Completion runs Cosmic's
 * normal quest path and Act.img/22512 pays the rewards; nothing is owed here.
 *
 * ponytail: one screen, not an invented conversation. Say.img/22512/0 is empty in v84 - GMS
...
function start(mode, type, selection) {
    qm.forceStartQuest();
    qm.sendOk("Talk to #p1010100# to continue.");
    qm.dispose();
}